...
extension UdacityClient {
    ...
    func authenticateWithViewController(_ hostViewController: UIViewController, _ params: [String: AnyObject], completionHandlerForAuth: @escaping (_ success: Bool, _ errorString: String?) -> Void) {
        ...
        self.getSessionID(params) { (success, sessionID, errorString) in
            if success {
    ...
    private func getSessionID(_ params: [String: AnyObject], completionHandlerForSession: @escaping (_ success: Bool, _ sessionID: String?, _ errorString: String?) -> Void) {
...
//    
//    func getPublicUserData(_ completionHandlerForFavMovies: @escaping (_ result: [ParseStudentInformation]?, _ error: NSError?) -> Void) {
//        
//        /* 1. Specify parameters, method (if has {key}), and HTTP body (if POST) */
...
//                    
//                    let students = ParseStudentInformation.studentsFromResults(results)
//                    completionHandlerForFavMovies(students, nil)
//                } else {
